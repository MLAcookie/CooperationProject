...
public class DialogBoxManager : MonoBehaviour
{
    ...
    public Text TalkText;//对话文本框
    private AudioSource printAudio;//打字音效
    public GameObject Bg; //背景图片
    public GameObject LeftPerson, CenterPerson, RightPerson;//三个人物会出现的位置
    ...
    private void Awake()
    {
        ...
        PositionToPersonPicture = new Dictionary<string, GameObject> { { "左", LeftPerson }, { "中", CenterPerson }, { "右", RightPerson } };
    }
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Escape))//按下esc按钮调出设置面板
        {
